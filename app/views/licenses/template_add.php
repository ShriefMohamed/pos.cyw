                                                                ...
                                                                <table class="tab_columns">
                                                                    ...
                                                                    <tr id="view_f_6">
                                                                        ...
                                                                        <td class="form_field_holder ">
                                                                            <input type="text" class="view_view data_control" name="template-name" placeholder="Randomly generated if left empty.">
                                                                        </td>
                                                                    </tr>
                                                                    <tr id="view_f_7">
                                                                        <td class="form_field_holder " colspan="2">
                                                                            <div>
                                                                                <div style="width: 100%; padding:10px;">
                                                                                    <p>This is what will contain what you add: <a target="_blank" href="<?= HOST_NAME ?>licenses/template_preview">Base Template</a></p>
                                                                    ...
                                                                    <tr id="view_f_25">
                                                                        <td colspan="2">
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="form_field_holder">
                                                                                        <textarea rows="5" cols="40" name="template" class="view_view textarea data_control" tabindex="206" required></textarea>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
                                                                            </table>
