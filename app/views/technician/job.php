                ...
                <div class="page-section">
                    <div class="row">
                        <div class="col-md-12">
                            <section class="card">
                                <div class="card-body">
                                    <form method="post" action="<?= HOST_NAME ?>technician/job_edit/<?= $item->id ?>">
                                        <fieldset>
                                                            ...
                                                            <?php foreach ($all_items as $one_item) : ?>
                                                                <?php if (in_array($one_item, $itemsLeft)) : ?>
                                                                    <div class="custom-control custom-control-inline custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" name="left-items[]" value="<?= $one_item ?>" id="<?= $one_item ?>" checked disabled>
                                            ...
                                            <fieldset style="margin-top: 20px" id="notes-section">
                                                <div class="row">
                                                    <div class="col-md-12">
                            ...
                            <div class="modal fade" id="approve-quotes-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="width: 150%; margin-left: -16%">
                                        <form method="post" action="<?= HOST_NAME ?>technician/approve_quotes/<?= $item->id ?>">
                            ...
                            <div class="modal fade" id="add-notes-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="post" action="<?= HOST_NAME ?>technician/job_note_add/<?= $item->id ?>">
                            ...
                            <div class="modal fade" id="edit-note-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="post" action="<?= HOST_NAME ?>technician/job_note_edit/<?= $item->id ?>">
                            ...
                            <div class="modal fade" id="add-files-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="post" action="<?= HOST_NAME ?>technician/job_attachment_add/<?= $item->id ?>" enctype="multipart/form-data">
                                            <div class="modal-header bg-info-dark">
                            ...
                            <div class="modal fade" id="add-tracking-info-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="post" action="<?= HOST_NAME ?>technician/job_tracking_info_add/<?= $item->id ?>">
                                            <div class="modal-header bg-info-dark">
...
<script>
    ...
    $(document).ready(function () {
        ...
        if (hash && $(hash).length > 0) {
            $('html, body').animate({
                scrollTop: $(hash).offset().top + ($(window).height() - $(hash).height())
            }, 800, function(){
            });
        }
        ...
        $(document).on('click', '.delete-attachment', function (e) {
            ...
            $.ajax({
                url: "<?= HOST_NAME ?>technician/job_attachment_delete/"+file_id,
                type: "POST",
                dataType: "json"
            }).done(function (data) {
                if (data == 1) {
        ...
        $(document).on('click', '.edit-note', function (e) {
            ...
            $.ajax({
                url: "<?= HOST_NAME ?>technician/job_note_get/"+note_id,
                type: "POST",
                dataType: "json"
            }).done(function (data) {
                if (data) {
        ...
        $(document).on('click', '.delete-note', function (e) {
            let note_id = e.target.dataset.content;
            $.ajax({
                url: "<?= HOST_NAME ?>technician/job_note_delete/"+note_id,
                type: "POST",
                dataType: "json"
            }).done(function (data) {
                if (data == 1) {
        ...
        $(document).on('click', '.remove-quote-btn', function (e) {
            ...
            $.ajax({
                url: "<?= HOST_NAME ?>technician/job_quote_delete/"+quote_id,
                type: "POST",
                dataType: "json"
            }).done(function (data) {
                if (data == 1) {
        ...
        $(document).on('click', '.remove-tracking-btn', function (e) {
            ...
            $.ajax({
                url: "<?= HOST_NAME ?>technician/job_tracking_info_delete/"+id,
                type: "POST",
                dataType: "json"
            }).done(function (data) {
                console.log(data);
