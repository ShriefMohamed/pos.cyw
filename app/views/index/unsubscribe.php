...
<div class="container">
    <div class="inner-container">
        ...
        <div class="bottom">
            <h2 class="title">We are sad to see you go!</h2>
            <p class="subtitle">You have been unsubscribed and will no longer hear from us.</p>
            <div class="buttons">
<!--                <button id="unsubscribe">Unsubscribe</button>-->
<!--                <button id="cancel">Cancel</button>-->

                <a href="<?= HOST_NAME ?>"><button id="unsubscribe">Home</button></a>
            </div>
        </div>
    </div>
