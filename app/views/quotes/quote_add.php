    ...
    <section class="card card-fluid">
        <div class="card-body" style="padding: 0;">
            <form method="post" id="quote-form" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-round last_name_input" name="l_name" placeholder="Last Name" required autocomplete="chrome-off">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                <div class="component-container hidden">
                    <div class="functions">
                    ...
                    <div class="main">
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered quote-table">
                            ...
                            <tr class="tr__total tr__total--labor">
                                ...
                                <td class="td__price" colspan="2">
                                    <input type="text" name="labor" value="0.00">
                                </td>
                            </tr>
